<?php
    ...
    function endElement($parser, $name)
    {
        ...
        if ($name == 'ITEM') {
            $rss2array_globals[items][] = [title => trim($rss2array_globals[current_title]), link => trim($rss2array_globals[current_link]), description => trim($rss2array_globals[current_description])];
